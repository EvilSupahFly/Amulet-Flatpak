...
REPO="https://github.com/EvilSupahFly/Amulet-Flatpak/releases/download/0.10.54/amulet-x86_64-0.10.54.flatpak"
...
cd $TEMP
wget "$REPO"
flatpak install -u -y amulet-x86_64-0.10.54.flatpak
