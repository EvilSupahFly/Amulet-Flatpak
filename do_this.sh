...
directories=("$BLD_DIR" ".flatpak-builder")
...
#report N "${WHT}flatpak --gpg-homedir=$HOME/.gnupg build-bundle -vvv amulet-x86_64.flatpak $AFPBASE"
#if ! flatpak --gpg-homedir=$HOME/.gnupg build-bundle -vvv amulet-x86_64.flatpak $AFPBASE; then
