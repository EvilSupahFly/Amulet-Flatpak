...
Currently the flatpak release suffers from two minor issues: 
  ...
  - missing water and lava textures, which is unique to the flatpak version [issue #5](https://github.com/EvilSupahFly/Amulet-Flatpak/issues/5) and still being investigated.
